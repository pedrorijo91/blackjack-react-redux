...
const Info = ({ waitingForBet, winner }) => (
  <div style={{ fontWeight: "bold" }}>
    ...
    {winner === GAME_RESULT.DEALER &&
      "Game over. Click 'Start Game' to start the round"}
    {winner === GAME_RESULT.PLAYER &&
      "You won. Click 'Start Game' to start the round"}
    {winner === GAME_RESULT.TIE &&
      "It's a tie! Click 'Start Game' to start the round"}
  </div>
);
